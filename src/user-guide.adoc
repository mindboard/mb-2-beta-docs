...
[NOTE]
By tapping image:icons/mb_buffers.png[title="Buffers"] button on ActionBar, you can open a previous document.
...
. Double tapping a target node handle by finger or stylus 
